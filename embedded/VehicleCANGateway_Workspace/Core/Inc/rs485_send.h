...
void Send_RS485_Message_B0(void) {
    ...
    // rs_msg.start_byte = 0xAA;
    rs_msg.start_byte = 0xB0; // id for triaxial x, y, and z msg
...
void RS485_Send(void){
	...
	// }
	static EasyTimer_t RS485TimerA0 = {.start_time = 0, .interval = 10};  // 50ms
...
//    RS485_Process_Queue(&huart1);
//    static EasyTimer_t RS485TimerB0 = {.start_time = 0, .interval = 10};  // 50ms
